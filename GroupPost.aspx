<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="GroupPost.aspx.cs" Inherits="GroupPost" %>
                        ...
                        <asp:TemplateField HeaderText="Option">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton2" CausesValidation=false runat="server" 
                                    CommandArgument='<%# Eval("Post_Id") %>' CommandName="Remove" 
                                    onclientclick="return confirm('Are You Sure To Remove?');">Remove</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
